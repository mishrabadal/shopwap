...
if ($response) {
    $store_data = "INSERT INTO branding (brand_name, brand_logo, email, domain_name, facebook_url, twitter_url, address, phone, about_us, privacy_policy, cookies_policy, terms_policy) VALUES ('$brand_name', '$logo' ,'$email','$domain_name', '$facebook_url', '$twitter_url', '$ address', '$phone', '$about_us', '$privacy_policy', '$
    cookies_policy', '$terms')";
